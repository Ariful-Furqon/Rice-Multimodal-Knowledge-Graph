# Verification report — v0.5-final
...
- Alignment IRIs used by more than one individual: 3
    ...
    - http://aims.fao.org/aos/agrovoc/c_7773: Reduced_Tillering (closeMatch), Tillering_Stage (closeMatch), Excessive_Tillering (closeMatch)
    - http://aims.fao.org/aos/agrovoc/c_27879: Insecticide_Application (closeMatch), Fungicide_Application (closeMatch)
