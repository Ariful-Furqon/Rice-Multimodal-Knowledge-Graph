...
- **CABI citation years.** Every CABI citation reads "CABI (2022)", but Crossref gives a different publication year for each of the 14 datasheets (2012, 2019, 2021 or 2025 — e.g. 49009 *Scirpophaga incertulas* 2021, 14691 *Bipolaris oryzae* 2025). The citation text was left unchanged pending a decision on whether to cite the datasheet version or the date accessed.
