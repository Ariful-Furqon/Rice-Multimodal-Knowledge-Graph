...
**Generated:** 2026-09-17 12:35  
**Ontology:** `Rice MMKG.rdf`  
**Asserted triples:** 67,863  
**After OWL RL materialisation:** 163,301 (+95,438, 22.8s)  
...
**Measurement.** 7 of 9 disease covered - 77.8% (73.9 ms).
...
**Measurement.** 21 of 22 disease/pest covered - 95.5% (10.1 ms).
...
**Measurement.** 17 of 22 disease/pest covered - 77.3% (6.5 ms).
...
**Measurement.** 39 of 39 symptom covered - 100.0% (3.9 ms).
...
**Measurement.** 13 of 22 disease/pest covered - 59.1% (31.1 ms).
...
**Measurement.** 1 of 1 declared vector covered - 100.0% (5.6 ms).
...
**Measurement.** 10 of 15 disease covered - 66.7% (813.8 ms).
...
**Measurement.** 0 answer(s) on the asserted graph, 1442 after OWL RL materialisation (**+1442** contributed by reasoning, 13.6 ms).
...
**Measurement.** 0 answer(s) on the asserted graph, 169 after OWL RL materialisation (**+169** contributed by reasoning, 6.5 ms).
...
**Measurement.** 8643 of 8643 diagnostic image covered - 100.0% (1844.4 ms).
...
**Measurement.** 10 of 10 annotated class covered - 100.0% (400.1 ms).
...
**Measurement.** 0 violation(s) (828.2 ms). Constraint holds.
...
**Measurement.** 353 of 353 reified axiom covered - 100.0% (13.6 ms).
...
**Measurement.** 0 violation(s) (192.6 ms). Constraint holds.
...
**Measurement.** 18 of 30 biological entity covered - 60.0% (7.2 ms).
...
**Measurement.** 0 violation(s) (11.1 ms). Constraint holds.
