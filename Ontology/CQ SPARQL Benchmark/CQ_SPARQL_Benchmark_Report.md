...
**Generated:** 2026-09-02 15:00  
**Ontology:** `Rice MMKG.rdf`  
**Asserted triples:** 66,873  
**After OWL RL materialisation:** 158,685 (+91,812, 33.9s)  
...
| CQ-25 | L4 | D1 | `negative` | **FAIL** | 1 violation(s) |
...
**Measurement.** 7 of 9 disease covered - 77.8% (337.2 ms).
...
**Measurement.** 15 of 16 disease/pest covered - 93.8% (33.2 ms).
...
**Measurement.** 15 of 16 disease/pest covered - 93.8% (24.1 ms).
...
**Measurement.** 28 of 28 symptom covered - 100.0% (8.0 ms).
...
**Measurement.** 13 of 16 disease/pest covered - 81.2% (54.4 ms).
...
**Measurement.** 6 of 7 growth stage covered - 85.7% (9.3 ms).
...
**Measurement.** 0 violation(s) (19.0 ms). Constraint holds.
...
**Measurement.** 1 of 2 preventive treatment covered - 50.0% (9.0 ms).
...
**Measurement.** 1 of 1 declared vector covered - 100.0% (15.8 ms).
...
**Measurement.** 1 violation(s) (7.1 ms). Constraint is broken.
...
**Measurement.** 9 of 9 disease covered - 100.0% (627.5 ms).
...
**Measurement.** 9 of 16 disease/pest covered - 56.2% (12.2 ms).
...
**Measurement.** 4 of 4 severity level covered - 100.0% (10.8 ms).
...
**Measurement.** 0 answer(s) on the asserted graph, 1442 after OWL RL materialisation (**+1442** contributed by reasoning, 30.1 ms).
...
**Measurement.** 0 answer(s) on the asserted graph, 139 after OWL RL materialisation (**+139** contributed by reasoning, 13.6 ms).
...
**Measurement.** 8643 of 8643 diagnostic image covered - 100.0% (2869.0 ms).
...
**Measurement.** 10 of 10 annotated class covered - 100.0% (574.6 ms).
...
**Measurement.** 1 of 28 symptom covered - 3.6% (24.0 ms).
...
**Measurement.** 0 violation(s) (1357.3 ms). Constraint holds.
...
**Measurement.** 0 individual(s) (2.5 ms). Recorded, not scored.
...
**Measurement.** 265 of 265 reified axiom covered - 100.0% (19.2 ms).
...
**Measurement.** 0 violation(s) (50.3 ms). Constraint holds.
...
**Measurement.** 18 of 24 biological entity covered - 75.0% (11.0 ms).
...
**Measurement.** 1 violation(s) (25.8 ms). Constraint is broken.

**Violating rows (sample):**

- `N60c2821ddb06435dae88e1988d197429` / `literature-curated`

---

### CQ-25 - Inferential - requires entailment / Agronomic / symbolic - **FAIL**
...
**Measurement.** 1 violation(s) (6.9 ms). Constraint is broken.
