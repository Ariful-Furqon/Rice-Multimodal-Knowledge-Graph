...
**Generated:** 2026-09-03 10:31  
**Ontology:** `Rice MMKG.rdf`  
**Asserted triples:** 66,874  
**After OWL RL materialisation:** 161,568 (+94,694, 24.0s)  
...
| CQ-04 | L1 | D1 | `coverage` | **PASS** | 27/27 symptom (100%) |
...
| CQ-10 | L3 | D1 | `negative` | **FAIL** | 1 violation(s) |
| CQ-11 | L3 | D1 | `coverage` | **PASS** | 9/9 disease (100%) |
| CQ-12 | L3 | D1 | `coverage` | **PASS** | 9/16 disease/pest (56%) |
| CQ-13 | L2 | D1 | `coverage` | **PASS** | 4/4 severity level (100%) |
| CQ-14 | L4 | D1 | `entailment` | **PASS** | 0 asserted -> 1442 entailed |
| CQ-15 | L4 | D1 | `entailment` | **PASS** | 0 asserted -> 140 entailed |
...
**Measurement.** 7 of 9 disease covered - 77.8% (234.7 ms).
...
**Measurement.** 15 of 16 disease/pest covered - 93.8% (9.5 ms).
...
**Measurement.** 15 of 16 disease/pest covered - 93.8% (6.8 ms).
...
**Measurement.** 27 of 27 symptom covered - 100.0% (4.4 ms).
...
**Measurement.** 13 of 16 disease/pest covered - 81.2% (33.2 ms).
...
**Measurement.** 6 of 7 growth stage covered - 85.7% (5.3 ms).
...
**Measurement.** 0 violation(s) (8.2 ms). Constraint holds.
...
**Measurement.** 1 of 2 preventive treatment covered - 50.0% (3.5 ms).
...
**Measurement.** 1 of 1 declared vector covered - 100.0% (5.0 ms).
...
### CQ-10 - Causal - multi-hop chain / Agronomic / symbolic - **FAIL**
...
**Measurement.** 1 violation(s) (2.4 ms). Constraint is broken.
...
**Measurement.** 9 of 9 disease covered - 100.0% (395.2 ms).
...
### CQ-12 - Causal - multi-hop chain / Agronomic / symbolic - **PASS**
...
**Measurement.** 9 of 16 disease/pest covered - 56.2% (6.0 ms).
...
**Measurement.** 4 of 4 severity level covered - 100.0% (5.3 ms).
...
**Measurement.** 0 answer(s) on the asserted graph, 1442 after OWL RL materialisation (**+1442** contributed by reasoning, 17.9 ms).
...
**Measurement.** 0 answer(s) on the asserted graph, 140 after OWL RL materialisation (**+140** contributed by reasoning, 7.7 ms).
...
**Measurement.** 8643 of 8643 diagnostic image covered - 100.0% (2106.6 ms).
...
**Measurement.** 10 of 10 annotated class covered - 100.0% (452.6 ms).
...
**Measurement.** 1 of 27 symptom covered - 3.7% (20.0 ms).
...
**Measurement.** 0 violation(s) (942.6 ms). Constraint holds.
...
**Measurement.** 0 individual(s) (1.6 ms). Recorded, not scored.
...
**Measurement.** 265 of 265 reified axiom covered - 100.0% (13.7 ms).
...
**Measurement.** 0 violation(s) (38.0 ms). Constraint holds.
...
**Measurement.** 18 of 24 biological entity covered - 75.0% (8.7 ms).
...
### CQ-24 - Inferential - requires entailment / Provenance and external alignment - **FAIL**
...
**Measurement.** 1 violation(s) (10.2 ms). Constraint is broken.

**Violating rows (sample):**

- `N14f7b5c7cffa4b6a9cc8baf7f8716a77` / `literature-curated`
...
**Measurement.** 0 violation(s) (2.1 ms). Constraint holds.
