...
**Triples:** 67,120 asserted / 161,916 after OWL RL materialisation (+94,796 triples)  
...
| **CQ-21** | L4 | D3 | `coverage`   | **PASS**       | 287/287 (100%)       | Reified domain axioms with source URI and citation (v0.6.2: 256/256; v0.6: 253/253) |
...
#### CQ-21 | L4 x D3 | coverage | PASS (287/287 axioms, 100%)
...
```
**Result:** 287 covered / 287 total (100.0%) — PASS. Source URIs by host: CABI (doi.org) 242, IRRI Rice Knowledge Bank 31, BBPOPT 7, IRAC 2, Plant Ontology 2, Wang et al. 2022 (doi.org) 2, FAO 1.  
...
```
**Result:** 0 violations — PASS. `rice:affectsPlantPart`, `rice:partOf` and `rice:hasTransmissionMode` were added to the property list in 0.7.0-dev together with the properties themselves.  
