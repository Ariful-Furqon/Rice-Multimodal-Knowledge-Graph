...
- ~~**Five SPARQL implementations.**~~ **Done 2026-09-08, extended to 15, and
  ...
  0.7.0-dev (2026-09-15) **9 answer in full, 8 answer in part, 2 return
  nothing** (v0.6.2: 7 / 10 / 2; `CQ-A02` became answerable when
  `hasTransmissionMode` was added, `CQ-A07` when `hasManagementCategory` was
  added and its query read the provenance axioms). `CQ-A01`, `A03`, `A06`,
  `A11`, `A13`, `A17` and `A24` are *partial - schema* (the ontology has
